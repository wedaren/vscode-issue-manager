...
一个强大的 VS Code 扩展，帮助您以树状结构高效管理和组织本地 Markdown 问题文件。通过智能创建、灵活关联和专注追踪功能，让您的知识管理更加有序和高效。ssue-manager 自述文件
...
### 🧠 智能问题创建
- **AI 增强**: 利用 LLM 智能优化问题标题，提供相似问题建议
- **统一体验**: 一个界面完成问题创建和相关内容发现
- **多选操作**: 同时创建多个问题或打开相关文件
- **Copilot 集成**: 在聊天过程中直接将讨论内容保存为问题

### 📊 三视图管理体系
- **问题总览**: 树状结构展示所有问题的层级关系
- **孤立问题**: 收件箱模式，管理未分类的新问题
- **关注问题**: 过滤重要问题，专注核心任务

### 🔗 灵活关联操作
- **拖拽组织**: 通过拖拽轻松建立问题间的父子关系
- **多重引用**: 同一问题可在树中多处引用，实现灵活分类
- **编辑器联动**: 与编辑器双向同步，支持拖拽生成 Markdown 链接
